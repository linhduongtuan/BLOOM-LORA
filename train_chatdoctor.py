...
LORA_DROPOUT = 0.05
VAL_SET_SIZE = 2000
DATA_PATH = "chatdoctor200k.json" ## Choose dataset
OUTPUT_DIR = "BLOOM-chatdoctor"

## Choose a model to finetune 
## reference here https://huggingface.co/bigscience/bloomz
...
#model_name = 'bigscience/bloomz' # for 176B parameters
